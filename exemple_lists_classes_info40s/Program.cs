...
namespace exemple_lists_classes_info40s
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Debug.WriteLine("Il y a " + Admin.numUser);
            ...
            while (true)
            {
                ...
                {
                    Console.Clear();
                    Console.WriteLine("\n\nIl y a " + Admin.numUser + " users au present\n");
                }
                else
                {
    ...
    class Admin
    {
        ...
        string _pass;//private by defualt
...
}//END OF THE NAMESPACE (REFERENCE TO THE FOLDER WHERE THIS RESIDES)